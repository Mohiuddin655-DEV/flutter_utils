...
class Converter {
  ...
  static int toDay(int timeMills) => DateProvider.toDay(timeMills);
  ...
  static int toMonth(int timeMills) => DateProvider.toMonth(timeMills);
  ...
  static String toUserName(
    ...
    final String current = Replacement.auto(name).lowercase;
    if (replacements != null) {
      return Replacement.multiple(current, regexList, replacements);
    } else {
  ...
  static int toYear(int timeMills) => DateProvider.toYear(timeMills);
}

...
class _PhoneFieldState extends State<PhoneField> {
  ...
  void initState() {
    ...
    _controller.setValidator(widget.validator);
        ...
        children: [
          Expanded(
            ...
            child: TextFormField(
              ...
              onChanged: (value) {
                isChangedState = true;
                _controller.onTextChange?.call(_controller.number);
              },
          ...
          Expanded(
            ...
            child: TextFormField(
              ...
              validator: (value) {
                return !_controller.isValid && isChangedState
                    ? widget.error
                    : null;
              },
              decoration: InputDecoration(
...
class PhoneEditingController {
  ...
  late bool Function(Number value)? validator;
  late Function(Number value)? onTextChange;
  ...
  void setTextChangeListener(Function(Number value) listener) {
    onTextChange = listener;
  }

  void setValidator(bool Function(Number value)? validator) {
